...
var data = [
  {
    ...
    heading: "Luis Miguel",
    description:
      "Luis Miguel: The Series  is a Spanish-language American biographical television series produced by Gato Grande Productions along to MGM Television for Netflix and Telemundo.[2][3] It is an authorized version on the life of the Mexican singer Luis Miguel.[4] It stars Diego Boneta as the titular character",
  },
  {
    src: "./Images/large-series2.jpg",
    heading: "Lucifer",
    description:
      "Lucifer is an American urban fantasy television series developed by Tom Kapinos that premiered on January 25, 2016, and concluded on September 10, 2021. It is based on the DC Comics character created by Neil Gaiman, Sam Kieth, and Mike Dringenberg taken from the comic book series The Sandman, who later became the protagonist of a spin-off comic book series, both published by DC Comics' Vertigo imprint. The series is produced by Jerry Bruckheimer Television, DC Entertainment and Warner Bros. ",
  },
  {
    src: "./Images/large-series3.jpg",
    heading: "Haunted Latin America",
    description:
      "Haunted: Latin America consists of real people telling real stories about possession, haunted houses, terrifying attacks by spirits, and other related stories. The format is the same as well; the person tells the story in a room with loved ones and others who experienced the same issues, and then there are dramatic reenactments of these scenes.",
  },
  {
    src: "./Images/large-series4.jpg",
    heading: "Who killed sara?",
    description:
      "Who Killed Sara? is a Mexican mystery thriller streaming television series created by José Ignacio Valenzuela and produced by Perro Azul, which was released for Netflix on 24 March 2021. The series stars Manolo Cardona as Álex Guzmán, a man convicted for the murder of his sister, a crime that he did not commit. Season 2 premiered on 19 May 2021, two months after the release of the first one.",
  },
  {
  ...
  },
  {
    ...
    heading: "Elite",
    description:
      "Elite is a Spanish thriller teen drama television series created for Netflix by Carlos Montero and Darío Madrona. The series is set in Las Encinas, a fictional elite secondary school and revolves around the relationships between three working-class students enrolled at the school through a scholarship program and their wealthy classmates. The series features an ensemble cast.",
  },
  {
...
function showVideo(value) {
  switch (value) {
    case value:
      ...
      document.getElementsByClassName("videoHeading")[0].innerText =
        data[value].heading;
      document.getElementsByClassName("videoDescription")[0].innerText =
...
function showTrending(value) {
  switch (value) {
    case value:
      ...
      document.getElementsByClassName("videoHeading")[1].innerText =
        data[value].heading;
      document.getElementsByClassName("videoDescription")[1].innerText =
        data[value].description;
      break;
  }
...
function showTopRated(value) {
  switch (value) {
    case value:
      ...
      document.getElementsByClassName("videoHeading")[2].innerText =
        data[value].heading;
      document.getElementsByClassName("videoDescription")[2].innerText =
        data[value].description;
      break;
  }
...
function showActionSeries(value) {
  switch (value) {
    case value:
      ...
      document.getElementsByClassName("videoHeading")[3].innerText =
        data[value].heading;
      document.getElementsByClassName("videoDescription")[3].innerText =
        data[value].description;
      break;
  }
...
function showHorrorSeries(value) {
  switch (value) {
    case value:
      ...
      document.getElementsByClassName("videoHeading")[4].innerText =
        data[value].heading;
      document.getElementsByClassName("videoDescription")[4].innerText =
        data[value].description;
      break;
  }
...
function showRomanticSeries(value) {
  switch (value) {
    case value:
      ...
      document.getElementsByClassName("videoHeading")[5].innerText =
        data[value].heading;
      document.getElementsByClassName("videoDescription")[5].innerText =
        data[value].description;
      break;
  }
...
function nextFunction(i) {
  const next = document.getElementsByClassName("next")[i];
  next.onclick = function () {
    document.getElementsByClassName("imagesDiv")[i].scrollLeft += 200;
  };
}
function prevFunction(i) {
  const prev = document.getElementsByClassName("prev")[i];
